...
public class LivrosC extends JFrame {
	...
	public LivrosC() {
		...
		JLabel lblaviso = new JLabel("Selecione um livro");
		...
		btnPiadaM.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 EmprestimoPM loginScreen = new EmprestimoPM();
			        
				 
			        loginScreen.setVisible(true);
			        LivrosC.this.dispose();
			}
		});
		...
		btnAmorI.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 EmprestimoAI loginScreen = new EmprestimoAI();
		...
		btnCorteC.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 EmprestimoCC loginScreen = new EmprestimoCC();
