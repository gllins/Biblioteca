...
import livro.Livro; // Certifique-se de que a classe Livro está importada
...
public class AdicionarLivro extends JFrame {
    ...
    public AdicionarLivro() {
        this(new Biblioteca()); // Cria uma biblioteca padrão caso não seja passado uma
    }
    ...
    private void initialize() {
        ...
        textDtLancamento.setBounds(55, 66, 86, 20);
        ...
        btnAdicionar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Validação de campos
                if (titulo.isEmpty() || autor.isEmpty() || paginasStr.isEmpty() || idioma.isEmpty() || editora.isEmpty() || anoStr.isEmpty() || avaliacaoStr.isEmpty()) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Erro: Verifique os campos numéricos (número de páginas, ano e avaliação).");
                }
            }
        });
        btnAdicionar.setBounds(163, 150, 89, 23);
        ...
        btnVoltar.setBounds(259, 150, 89, 23);
