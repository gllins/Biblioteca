...
public class Eai extends JFrame {
	...
	public Eai() {
		...
		btnVoltar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			        EmprestimoAI emprestimoAI = new EmprestimoAI();
					emprestimoAI.setVisible(true);
			         Eai.this.dispose();
			}
		});
