...
public class EmprestimoCC extends JFrame {
	...
	public EmprestimoCC() {
		...
		JLabel lblCapaCorteC = new JLabel("");
		lblCapaCorteC.setBounds(10, 11, 94, 173);
		lblCapaCorteC.setIcon(new ImageIcon("C:\\Users\\USER\\Downloads\\Design sem nome (6).png"));
		contentPane.add(lblCapaCorteC);
		
		JLabel lblCorteCt = new JLabel("Batman: A Corte das Corujas");
		lblCorteCt.setFont(new Font("Times New Roman", Font.PLAIN, 25));
		lblCorteCt.setForeground(new Color(0, 128, 255));
		lblCorteCt.setBounds(114, 11, 311, 36);
		contentPane.add(lblCorteCt);
		...
		lblNewLabel_1.setBounds(138, 58, 106, 36);
		...
		JLabel lblNewLabel_5 = new JLabel("Avaliação (0 a 5): 4,9");
		...
		btnEmprestimo.setBounds(151, 227, 128, 23);
